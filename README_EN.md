...
- Orchestrator: lets you choose or create one AI CLI as the swarm brain, dispatches planned tasks to worker sessions by capability, parses `CLI_DECK_RESULT` blocks, and queues follow-up review, test, or research work.
