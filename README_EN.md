...
- Orchestrator: development tasks enter the Task Board and dispatch to workers; the Brain only plans and receives status, and is excluded from the default worker pool.
